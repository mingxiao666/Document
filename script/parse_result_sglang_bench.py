...
input_file_path = 'tmp.out.0.4.3.post2.2node.cu128.4nics.loog'
output_file_path = 'tmp.out.0.4.3.post2.2node.cu128.4nics.loog.csv'
...
# 手动指定配置信息和性能指标的顺序
predefined_keys = [
    'max_prefill', 'max_running_requests', 'torch_compile', 'is_dp',
